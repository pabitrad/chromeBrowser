...
{
    class AnimatedTrackControl : System.Windows.Controls.Image
    {
        ...
        void AnimatedGIFControl_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            if (Properties.Resources.loadImage != null)
            {
                _bitmap = Properties.Resources.establish_popups;
                //Width = 900; // _bitmap.Width;
                //Height = 200;// _bitmap.Height;
