...
namespace CatenaLogic.Windows.Presentation.WebcamPlayer
{
    public class CapDevice : DependencyObject, IDisposable
    {
        ...
        /// </summary>
        public FilterInfo[] DeviceMonikers
        {
            get
            {
        ...
        /// </summary>
        /// 
        public List<CapDevice> devices = new List<CapDevice>();
        public CapDevice[] Devices
        {
            get
            {
                // Declare variables
        ...
        public void DelDevices()
        {
           
            {
               ...
               // foreach (FilterInfo moniker in DeviceMonikers)
                {
                    devices.RemoveAt(0);// (new CapDevice(moniker.MonikerString));
                }
